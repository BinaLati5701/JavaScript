...
//Lastly, these DOM elements can listen for events. 
//After we’ve placed all the p-tags into the body (using the above loop), let’s put an event listener on them! 
