...
replace each string with a number - the length of the string
 at the previous array index - and return the array.  For example, 
 ...
 console.log(previousLengths(["hello", "dojo", "awesome", "puppy", "cat", "boo"]))